...
# ###################################################################
FROM $BUILDER_NS/humble-builder-rmf-web:$TAG
...
ARG DOMAIN_URL="localhost:8000"

ARG PUBLIC_URL="/dashboard"
#ARG REACT_APP_TRAJECTORY_SERVER="ws://${DOMAIN_URL}/trajectory"
#ARG REACT_APP_RMF_SERVER="http://${DOMAIN_URL}/rmf/api/v1"
ARG REACT_APP_TRAJECTORY_SERVER="ws://localhost:8006"
ARG REACT_APP_RMF_SERVER="http://localhost:8000"
ARG REACT_APP_AUTH_PROVIDER="stub"
ARG REACT_APP_KEYCLOAK_CONFIG='{"realm": "rmf-web", "clientId": "dashboard", "url" : "http://'${DOMAIN_URL}'/auth"}'
